...
export default function VolunteerHero2() {
  return (
    <section className="flex flex-col relative gap-6 ma-w-5xl py-37.5 justify-center items-center px-6 md:px-[100px] bg-(--navy)">
      ...
      <button className="bg-[#BDD733] rounded-lg text-sm font-semibold text-black px-8 py-3 shadow-[3px_6px_0_rgba(244,134,54,1)]">
        Be a Volunteer
      </button>
    </section>
  );
