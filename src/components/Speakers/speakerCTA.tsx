  ...
  return (
    <section className="bg-(--navy) py-18 px-6 md:px-16">
      <div className="max-w-6xl mx-auto">
        <div className="bg-linear-to-br from-[#F4863633] to-transparent rounded-xl py-22 px-6 flex flex-col items-center text-center gap-4">
          ...
          <a
            href="#"
            className="flex mt-2 items-center gap-2 bg-[#c8e63c] hover:opacity-90 transition-opacity text-[#031632] font-bold px-10 py-4 rounded-xl text-[15px] shadow-[3px_6px_0_rgba(244,134,54,1)]"
          >
            <BsMicFill size={16} />
            Become a Speaker
          </a>
